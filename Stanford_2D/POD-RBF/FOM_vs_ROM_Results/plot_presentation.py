...
def plot_3d_surface_animation(U_FOM, U_POD_RBF, X, Y, mu1, mu2, num_modes, filename='3d_surface_animation.gif', max_frames=500):
...
def plot_2d_heatmap_animation(U_FOM, U_POD_RBF, X, Y, mu1, mu2, filename='heatmap_animation.gif', max_frames=500):
...
if __name__ == "__main__":
    ...
    U_POD_RBF = np.load(os.path.join(f"reconstructed_snapshot_pod_rbf.npy"))
