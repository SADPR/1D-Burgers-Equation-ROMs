...
setup_files = [
    "setup_boundary_condition.py",
    "setup_convection_matrix_supg.py",
    "setup_diffusion_matrix.py",
    "setup_forcing_vector.py",
    "setup_mass_matrix_parallel.py",
    "setup_sparse_solver_parallel.py"
]
